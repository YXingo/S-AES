    ...
    <el-main class="main">
      ...
      <div class="rightSide">
        ...
        <div class="rightTitle">
          ...
          <h2 v-if="cardID == 2" class="title">多重加密</h2>
          <h2 v-if="cardID == 3" class="title">工作模式</h2>
        </div>
